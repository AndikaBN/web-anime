...
$movieAnimeHead = Query("SELECT * FROM animes WHERE kategori = 'Movie' ORDER BY rating DESC LIMIT 3");
$movieAnimeHead = Query("SELECT * FROM animes WHERE kategori = 'Movie'");
...
<body>
    <header>
        ...
        <nav class="navbar">
            ...
            <a href="movie.php" class="link active">movie</a>
        </nav>
        <div class="icons">
    ...
    <section class="home" id="home">
        <div class="swiper home-slider">
            <div class="swiper-wrapper">
                <?php foreach ($movieAnimeHead as $row): ?>
